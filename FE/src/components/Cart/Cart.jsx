  ...
  return (
    <div className={`${styles.Container_Cart} mt-2 shadow rounded  py-3 px-3 rounded border border-2 border-secondary d-flex align-items-center justify-content-center`}>
      <div>
        ...
        <div className={`${styles.itemContent} Content_Item text-center fw-bold mt-3`}>Vsmart Live4 Rẻ Đẹp Chính Hãng</div>
        <div className={`${styles.oldPrice} Price_Item_Old text-center m-1 text-decoration-line-through`}>Giá cũ: 3.599.000đ</div>
        <div className={`${styles.newPrice} Price_Item text-center m-1 text-danger fw-medium`}>Giá mới: 2.599.000đ</div>
