  ...
  return (
    <div className={`${styles.Container_Cart} mt-2 shadow rounded py-3 px-3 rounded border border-2 border-secondary d-flex align-items-center justify-content-center`}>
      <div>
        ...
        <div className='Content_Item text-center fw-bold mt-3'>{name}</div>
        <div className='Price_Item_Old text-center m-1 text-decoration-line-through'>Giá cũ: {oldPrice}</div>
        <div className='Price_Item text-center m-1 text-danger fw-medium'>Giá mới: {newPrice}</div>
